...
func initClocks() {
	...
	rp2040.CLOCKS.CLK_SYS_CTRL.ClearBits(rp2040.CLOCKS_CLK_SYS_CTRL_SRC_Msk)
	for rp2040.CLOCKS.CLK_SYS_SELECTED.Get() != rp2040.CLOCKS_CLK_SYS_CTRL_SRC_CLKSRC_CLK_SYS_AUX {
	}

	rp2040.CLOCKS.CLK_REF_CTRL.ClearBits(rp2040.CLOCKS_CLK_REF_CTRL_SRC_Msk)
	for rp2040.CLOCKS.CLK_REF_SELECTED.Get() != rp2040.CLOCKS_CLK_REF_CTRL_SRC_CLKSRC_CLK_REF_AUX {
	}
}
